...
vpc_name = "Stag-Env-Yashwanth-vpc"

# public subnet variable values 

pub_sub_cidr_block = "10.1.1.0/24"
pub_sub_az = "us-east-2a"
pub_sub_name = "Stag-Env-Yashwanth-pub-subnet"

# private subnet variable values
pvt_sub_cidr_block = "10.1.2.0/24"
pvt_sub_az = "us-east-2b"
pvt_sub_name = "Stag-Env-Yashwanth-pvt-subnet"

# Internet Gate Way variables 
igw_name = "Stag-Env-Yashwanth-igw"

# Public Route table
pub_rt_cidr_block = "0.0.0.0/0"
pub_rt_name = "Stag-Env-Yashwanth-pub-rt"

# Private Route table
pvt_rt_name = "Stag-Env-Yashwanth-pvt-rt"
pvt_rt_cidr_block = "0.0.0.0/0"

# Elastic IP
eip_name = "Stag-Env-Yashwanth-eip"

# NAT Gateway
nat_gw_name = "Stag-Env-Yashwanth-gw-NAT"

# Key Pair
keypair_name = "Stag-Env-yashwanth-keypair-new"
...
pub_instance_name  = "Stag-Env-Yashwanth-public-instance"
pvt_instance_name  = "Stag-Env-Yashwanth-private-instance"
